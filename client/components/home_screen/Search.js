...
//   const sourceUri = 'https://financialmodelingprep.com/api/v3/company/stock/list';
//   const destUri = FileSystem.documentDirectory + 'symbol.csv';
//   return FileSystem.downloadAsync(sourceUri, destUri)
//     .then(({ uri }) => {
//       console.log('Finished downloading to ', uri);
//       return FileSystem.readAsStringAsync(uri).then(res => JSON.parse(res).symbolsList);
//     })
//     .catch(error => {
//       console.error(error);
//     });

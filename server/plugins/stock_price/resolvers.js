...
const intradayPriceResolver = (parent, args, context, info) => {
  const interval = config.stock_price.intraday.interval,
    ...
    url = stockPriceHelper.stockIntradayURL(
      parent.symbol,
      interval,
      outputsize
    );
...
module.exports = {
  ...
  StockPrice: {
    intraday: (parent, args, context) => {
      return intradayPriceResolver(parent, args, context);
    },
    intraday_h: (parent, args, context) => {
      return intradayHPriceResolver(parent, args, context);
    },
    daily: (parent, args, context) => {
      return dailyPriceResolver(parent, args, context);
    }
  }
};
